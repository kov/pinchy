...
fn memfd_test() -> anyhow::Result<()> {
    unsafe {
        ...
        let fd1 = libc::syscall(syscalls::SYS_memfd_create as i64, name1.as_ptr(), 0x0001);
        ...
        let fd2 = libc::syscall(syscalls::SYS_memfd_create as i64, name2.as_ptr(), 0x0002);
        ...
        let fd3 = libc::syscall(syscalls::SYS_memfd_create as i64, name3.as_ptr(), 0x0003);
...
fn syslog_test() -> anyhow::Result<()> {
    unsafe {
        ...
        let result = libc::syscall(
            libc::SYS_syslog,
            10i32, // SYSLOG_ACTION_SIZE_BUFFER
            std::ptr::null_mut::<u8>(),
            0i32,
        );
        ...
        let result = libc::syscall(
            libc::SYS_syslog,
            9i32, // SYSLOG_ACTION_SIZE_UNREAD
            std::ptr::null_mut::<u8>(),
            0i32,
        );
        ...
        let _result = libc::syscall(
            libc::SYS_syslog,
            8i32, // SYSLOG_ACTION_CONSOLE_LEVEL
            std::ptr::null_mut::<u8>(),
        ...
        let _result = libc::syscall(
            libc::SYS_syslog,
            6i32, // SYSLOG_ACTION_CONSOLE_OFF
            std::ptr::null_mut::<u8>(),
            0i32,
        );
