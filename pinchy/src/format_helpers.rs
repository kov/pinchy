...
pub fn format_memfd_create_flags(flags: u32) -> Cow<'static, str> {
    ...
    if flags & memfd_constants::MFD_CLOEXEC != 0 {
        parts.push(Cow::Borrowed("MFD_CLOEXEC"));
    }

    if flags & memfd_constants::MFD_ALLOW_SEALING != 0 {
        parts.push(Cow::Borrowed("MFD_ALLOW_SEALING"));
    }

    if flags & memfd_constants::MFD_HUGETLB != 0 {
        parts.push(Cow::Borrowed("MFD_HUGETLB"));
    }

    if flags & memfd_constants::MFD_NOEXEC_SEAL != 0 {
        parts.push(Cow::Borrowed("MFD_NOEXEC_SEAL"));
    }

    if flags & memfd_constants::MFD_EXEC != 0 {
        parts.push(Cow::Borrowed("MFD_EXEC"));
    }
    ...
    if huge_flags != 0 {
        let huge_str: Cow<'static, str> = match huge_flags {
            memfd_constants::MFD_HUGE_64KB => Cow::Borrowed("MFD_HUGE_64KB"),
            memfd_constants::MFD_HUGE_512KB => Cow::Borrowed("MFD_HUGE_512KB"),
            memfd_constants::MFD_HUGE_1MB => Cow::Borrowed("MFD_HUGE_1MB"),
            memfd_constants::MFD_HUGE_2MB => Cow::Borrowed("MFD_HUGE_2MB"),
            memfd_constants::MFD_HUGE_8MB => Cow::Borrowed("MFD_HUGE_8MB"),
            memfd_constants::MFD_HUGE_16MB => Cow::Borrowed("MFD_HUGE_16MB"),
            memfd_constants::MFD_HUGE_32MB => Cow::Borrowed("MFD_HUGE_32MB"),
            memfd_constants::MFD_HUGE_256MB => Cow::Borrowed("MFD_HUGE_256MB"),
            memfd_constants::MFD_HUGE_512MB => Cow::Borrowed("MFD_HUGE_512MB"),
            memfd_constants::MFD_HUGE_1GB => Cow::Borrowed("MFD_HUGE_1GB"),
            memfd_constants::MFD_HUGE_2GB => Cow::Borrowed("MFD_HUGE_2GB"),
            memfd_constants::MFD_HUGE_16GB => Cow::Borrowed("MFD_HUGE_16GB"),
            _ => {
                let huge_size =
                    (flags >> memfd_constants::MFD_HUGE_SHIFT) & memfd_constants::MFD_HUGE_MASK;
                Cow::Owned(format!("MFD_HUGE_{}", huge_size))
            }
        };
    ...
    let parts_str: Vec<&str> = parts.iter().map(|p| p.as_ref()).collect();

    format!("0x{:x} ({})", flags, parts_str.join("|")).into()
}
