...
syscall_test!(
    parse_dup3,
    {
        ...
        crate::tests::make_compact_test_data(SYS_dup3, 1, 4, &data)
    },
...
syscall_test!(
    parse_dup3_with_flags,
    {
        ...
        crate::tests::make_compact_test_data(SYS_dup3, 1, 5, &data)
    },
...
async fn parse_epoll_pwait_multiline() {
    ...
    handle_event(&header, &payload, formatter).await.unwrap();
...
syscall_test!(
    parse_fcntl,
    {
        ...
        crate::tests::make_compact_test_data(SYS_fcntl, 22, 2, &data)
    },
...
syscall_test!(
    parse_fcntl_setfl,
    {
        ...
        crate::tests::make_compact_test_data(SYS_fcntl, 42, 0, &data)
    },
...
syscall_test!(
    parse_fcntl_dupfd,
    {
        ...
        crate::tests::make_compact_test_data(SYS_fcntl, 100, 7, &data)
    },
...
syscall_test!(
    parse_dup,
    {
        let data = DupData { oldfd: 3 };

        crate::tests::make_compact_test_data(SYS_dup, 1, 4, &data)
    },
    "1 dup(oldfd: 3) = 4 (fd)\n"
);
...
syscall_test!(
    parse_dup2,
    {
        let data = Dup2Data { oldfd: 3, newfd: 5 };

        crate::tests::make_compact_test_data(SYS_dup2, 1, 5, &data)
    },
...
syscall_test!(
    parse_close_range,
    {
        let data = CloseRangeData {
            fd: 3,
            max_fd: 10,
            flags: 0,
        };

        crate::tests::make_compact_test_data(SYS_close_range, 1, 0, &data)
    },
...
syscall_test!(
    test_epoll_create1,
    {
        let data = EpollCreate1Data {
            flags: libc::EPOLL_CLOEXEC,
        };

        crate::tests::make_compact_test_data(SYS_epoll_create1, 1001, 5, &data)
    },
...
syscall_test!(
    test_epoll_create,
    {
        let data = EpollCreateData { size: 10 };

        crate::tests::make_compact_test_data(SYS_epoll_create, 1001, 5, &data)
    },
...
syscall_test!(
    parse_flock,
    {
        ...
        crate::tests::make_compact_test_data(SYS_flock, 123, 0, &data)
    },
...
syscall_test!(
    parse_flock_unlock,
    {
        ...
        crate::tests::make_compact_test_data(SYS_flock, 456, 0, &data)
    },
...
syscall_test!(
    parse_io_setup,
    {
        let data = IoSetupData {
            nr_events: 1024,
            ctx_idp: 0x7ffe12345678,
        };

        crate::tests::make_compact_test_data(SYS_io_setup, 123, 0, &data)
    },
...
syscall_test!(
    parse_io_destroy,
    {
        let data = IoDestroyData { ctx_id: 0x12345678 };

        crate::tests::make_compact_test_data(SYS_io_destroy, 123, 0, &data)
    },
...
syscall_test!(
    parse_io_submit,
    {
        ...
        crate::tests::make_compact_test_data(SYS_io_submit, 123, 2, &data)
    },
...
syscall_test!(
    parse_io_cancel,
    {
        ...
        crate::tests::make_compact_test_data(SYS_io_cancel, 123, 0, &data)
    },
...
syscall_test!(
    parse_io_getevents,
    {
        ...
        crate::tests::make_compact_test_data(SYS_io_getevents, 123, 2, &data)
    },
...
syscall_test!(
    parse_io_pgetevents_with_sigset,
    {
        ...
        crate::tests::make_compact_test_data(SYS_io_pgetevents, 123, 1, &data)
    },
...
syscall_test!(
    parse_io_uring_setup,
    {
        ...
        crate::tests::make_compact_test_data(SYS_io_uring_setup, 321, 7, &data)
    },
...
syscall_test!(
    parse_io_uring_enter,
    {
        ...
        crate::tests::make_compact_test_data(SYS_io_uring_enter, 222, 1, &data)
    },
...
syscall_test!(
    parse_io_uring_register,
    {
        ...
        crate::tests::make_compact_test_data(SYS_io_uring_register, 444, 0, &data)
    },
