...
use pinchy_common::{
    kernel_types::{Timespec, Timeval, Timex, Itimerspec, Sigevent},
    syscalls::{
    ...
    TimerCreateData, TimerDeleteData, TimerGetoverrunData, TimerGettimeData, TimerSettimeData,
};
...
syscall_test!(
    ...
    "1000 timer_create(clockid: CLOCK_REALTIME, sevp: { sigev_notify: SIGEV_SIGNAL, sigev_signo: 10, sigev_value: 0x12345678, sigev_tid: 0 }, timerid: <output>) = 0 (success)\n"
);
